...
import chipMap from "../modules/chiptext.js";
// import randomTracksPromise from "../modules/randomTracks";

const tracksDaily = [
  "Bruno Mars - Die With A Smile", "take me to church", "As it Was", "Not Like Us",
  "too sweet hozier", "thats so true", "apt.", "sailor's song", "luther",
  "Sweater weather", "all the stars", "take on me", "sunflower", "Circles",
  "perfect", "SummerTime Sadness", "Counting Stars", "End of Beginning",
  "Night Changes", "beaniw", "deathbed", "safe and sound", "Skyfall",
  "until I found you", "despacito", "HUMBLE"
];

function HomePage({ userName, selectedSection, setSection }) {
...
// useEffect(() => {
//   randomTracksPromise.then((tracks) => {
//     console.log(tracks); // 10 tracks ready
//   });
// }, []);
      ...
      <div className="flex flex-row flex-wrap justify-center mb-5">
        {loading ? (
          Array.from({ length: 20 }).map((_, index) => (
            <div key={index} className="p-2 glassmorpho m-1 rounded-xl">
