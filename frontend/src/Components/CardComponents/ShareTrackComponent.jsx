            ...
            return new Promise((resolve, reject) => {
                img.onload = () => {
                    try {
                        ...
                        ctx.font = 'bold 36px Host Grotesk, Arial, sans-serif';
                        ctx.textAlign = 'left';
                        ...
                        ctx.font = '28px Host Grotesk, Arial, sans-serif';
                        ...
                        if (explicit) {
                            ...
                            ctx.fillRect(titleX, titleY + 200, 80, 25);
                            ctx.fillStyle = '#ffffff';
                            ctx.font = 'bold 14px Host Grotesk, Arial, sans-serif';
                            ctx.textAlign = 'center';
                            ctx.fillText('EXPLICIT', titleX + 40, titleY + 217);
                            ctx.textAlign = 'left';
                        }
                        ...
                        ctx.textAlign = 'center';
                        ctx.fillText('Check it out on GrooveEstrella', canvas.width / 2, canvas.height - 100);
