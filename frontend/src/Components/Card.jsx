...
import { Bookmark, BookmarkPlus, Check, CirclePlay, Award } from "lucide-react"; // Adjust imports if needed
...
{saved && (
  <span className="absolute bottom-full mt-1 left-1/2 -translate-x-1/2 opacity-0 scale-95 group-hover:opacity-100 group-active:scale-100 group-active:opacity-100 group-hover:scale-100 transition-all duration-300 bg-black text-white px-2 py-1 rounded text-sm">
